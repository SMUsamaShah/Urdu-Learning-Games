...
Every sound effect is synthesised at runtime, and the background tune is played
live on five sampled notes of a music box — about 75 KB of audio in total, all
precached, so it works on a plane.
...
public/audio/
  ...
  instruments/      GENERATED by npm run instruments. Notes the tune is played on.
